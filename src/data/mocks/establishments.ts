...
export const mockClinics: MockClinic[] = [
  { id: "cl-1", name: "Clinique El Manar", slug: "clinique-el-manar", city: "Tunis", address: "Rue du Lac Biwa, Les Berges du Lac, 1053 Tunis", phone: "+216 71 960 000", services: ["Cardiologie", "Chirurgie", "Maternité", "Pédiatrie", "Imagerie"], rating: 4.5, description: "Clinique privée pluridisciplinaire située aux Berges du Lac, offrant des soins de qualité depuis 1998." },
  { id: "cl-2", name: "Clinique Avicenne", slug: "clinique-avicenne", city: "Tunis", address: "15 Rue Avicenne, Mutuelleville, 1002 Tunis", phone: "+216 71 788 000", services: ["Ophtalmologie", "ORL", "Dermatologie", "Chirurgie esthétique"], rating: 4.7, description: "Clinique spécialisée en ophtalmologie et chirurgie esthétique, réputée pour son équipement de pointe." },
  { id: "cl-3", name: "Clinique Les Oliviers", slug: "clinique-les-oliviers", city: "Sousse", address: "Route de la Corniche, 4000 Sousse", phone: "+216 73 200 100", services: ["Chirurgie générale", "Orthopédie", "Urologie", "Gastro-entérologie"], rating: 4.3, description: "Clinique polyvalente offrant un large panel de spécialités chirurgicales à Sousse." },
  { id: "cl-4", name: "Clinique Hannibal", slug: "clinique-hannibal", city: "Tunis", address: "Rue du Lac Turkana, Les Berges du Lac, 1053 Tunis", phone: "+216 71 164 164", services: ["Chirurgie esthétique", "Chirurgie bariatrique", "Cardiologie", "Neurologie"], rating: 4.6, description: "Clinique internationale spécialisée dans la chirurgie esthétique et la médecine de pointe." },
  { id: "cl-5", name: "Clinique Pasteur", slug: "clinique-pasteur", city: "Tunis", address: "6 Place Pasteur, 1002 Tunis", phone: "+216 71 843 843", services: ["Médecine interne", "Pneumologie", "Rééducation", "Laboratoire"], rating: 4.4, description: "Clinique historique au cœur de Tunis, reconnue pour ses services de médecine interne." },
];
