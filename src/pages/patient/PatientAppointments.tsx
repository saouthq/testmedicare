                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex gap-2 mt-3">
                      ...
                      {a.hasPrescription && <Button variant="outline" size="sm" className="h-7 text-xs">Ordonnance</Button>}
                      <Button variant="outline" size="sm" className="h-7 text-xs">Reprendre RDV</Button>
                    </div>
                  </div>
                </div>
              </div>
