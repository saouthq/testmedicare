          ...
          <div className="flex flex-col sm:flex-row items-start gap-6">
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-bold text-foreground">Jean Dupont</h2>
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className="text-foreground">jean.dupont@email.com</span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <Phone className="h-4 w-4 text-muted-foreground" />
                  <span className="text-foreground">06 12 34 56 78</span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                ...
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className="text-foreground">Né le 15/03/1985</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="rounded-xl border bg-card p-6 shadow-card">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg bg-muted/50 p-4">
              ...
              <p className="font-medium text-foreground mt-1">A+</p>
            </div>
            <div className="rounded-lg bg-muted/50 p-4">
              <p className="text-sm text-muted-foreground">Allergies</p>
              <p className="font-medium text-foreground mt-1">Pénicilline</p>
            </div>
            <div className="rounded-lg bg-muted/50 p-4">
              <p className="text-sm text-muted-foreground">Médecin traitant</p>
              <p className="font-medium text-foreground mt-1">Dr. Sophie Martin</p>
            </div>
            <div className="rounded-lg bg-muted/50 p-4">
              <p className="text-sm text-muted-foreground">N° Sécurité sociale</p>
              <p className="font-medium text-foreground mt-1">1 85 03 75 *** *** **</p>
            </div>
          </div>
        </div>
