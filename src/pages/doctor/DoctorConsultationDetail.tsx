      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between flex-wrap gap-3 sticky top-16 z-20 bg-background/80 backdrop-blur-md py-3 -mx-6 px-6 border-b">
          ...
          <div className="flex gap-2">
            ...
            <Button className="gradient-primary text-primary-foreground shadow-primary-glow" size="sm"><Send className="h-3.5 w-3.5 mr-1" />Clôturer consultation</Button>
          </div>
        </div>
        ...
        <div className="rounded-xl border bg-card p-4 shadow-card">
          <div className="flex flex-col sm:flex-row sm:items-center gap-4">
            ...
            <div className="flex gap-2">
              <Link to="/dashboard/doctor/patient/1"><Button variant="outline" size="sm" className="text-xs"><History className="h-3.5 w-3.5 mr-1" />Historique</Button></Link>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-4 lg:grid-cols-3">
          ...
          <div className="space-y-4">
            <div className="rounded-xl border bg-card p-5 shadow-card"><h3 className="font-semibold text-foreground mb-4 flex items-center gap-2"><History className="h-4 w-4 text-primary" />Historique récent</h3></div>
          </div>
        </div>
      </div>
    </DashboardLayout>
