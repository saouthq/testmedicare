...
const appointments: Record<string, Appointment> = {
  "Lun 17-09:00": { patient: "Marie Dupont", type: "Consultation", duration: 1, color: "primary", motif: "Suivi diabète" },
  "Lun 17-09:30": { patient: "Jean Martin", type: "Suivi", duration: 1, color: "accent", motif: "Contrôle tension" },
  "Lun 17-10:30": { patient: "Claire Petit", type: "Première visite", duration: 2, color: "warning", motif: "Bilan initial" },
  "Mar 18-08:30": { patient: "Luc Bernard", type: "Contrôle", duration: 1, color: "accent", motif: "Douleurs articulaires" },
  "Mar 18-10:00": { patient: "Sophie Moreau", type: "Téléconsultation", duration: 1, color: "primary", teleconsultation: true, motif: "Renouvellement" },
  "Mar 18-14:00": { patient: "Paul Leroy", type: "Suivi", duration: 1, color: "accent", motif: "Cholestérol" },
  "Mar 18-15:30": { patient: "Anne Dubois", type: "Consultation", duration: 1, color: "primary", motif: "Check-up" },
  "Mer 19-09:00": { patient: "Anne Dubois", type: "Consultation", duration: 1, color: "primary", motif: "Consultation" },
  "Mer 19-11:00": { patient: "Marc Roux", type: "Première visite", duration: 2, color: "warning", motif: "Bilan" },
  "Jeu 20-08:00": { patient: "Julie Blanc", type: "Contrôle", duration: 1, color: "accent", motif: "Suivi" },
  "Jeu 20-14:30": { patient: "Pierre Noir", type: "Téléconsultation", duration: 1, color: "primary", teleconsultation: true, motif: "Résultats" },
  "Jeu 20-16:00": { patient: "Emma Laurent", type: "Consultation", duration: 1, color: "primary", motif: "Certificat" },
  "Ven 21-09:30": { patient: "Emma Vert", type: "Suivi", duration: 1, color: "accent", motif: "Suivi grossesse" },
  "Ven 21-15:00": { patient: "Hugo Gris", type: "Consultation", duration: 1, color: "primary", motif: "Consultation" },
};
...
const DoctorSchedule = () => {
  ...
  const todayStats = {
    total: Object.keys(appointments).filter(k => k.startsWith(selectedDay)).length,
    teleconsultation: Object.entries(appointments).filter(([k, v]) => k.startsWith(selectedDay) && v.teleconsultation).length,
  };
          ...
          <div className="flex items-center gap-2">
            <div className="flex gap-1 rounded-lg border bg-card p-0.5">
              <button 
                ...
                className={`rounded-md p-2 text-xs font-medium transition-colors ${view === "week" ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:text-foreground"}`}
              >
                <LayoutGrid className="h-4 w-4" />
              </button>
              <button 
                onClick={() => setView("day")}
                className={`rounded-md p-2 text-xs font-medium transition-colors ${view === "day" ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:text-foreground"}`}
              >
              ...
              <button 
                ...
                className={`rounded-xl px-4 py-3 text-center min-w-[80px] transition-all ${
                  selectedDay === d 
                    ...
                    : "border bg-card text-foreground hover:border-primary/50"
                }`}
              >
